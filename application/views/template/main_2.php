...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper"><i class="fas fa-gas-pump"></i>
        <a class="navbar-brand " href="">FMS</a>
        <!-- <a class="navbar-brand " href="assets/index.html"><img src="assets/images/logo_mini.svg" alt="logo"></a> -->
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <p class="page-name d-none d-lg-block">{user_greeting}<!-- Hi, Dave Mattew --></p>
        <ul class="navbar-nav ml-lg-auto">
          ...
          <li class="nav-item d-none d-sm-block profile-img">
            ...
            <a class="nav-link profile-image" href="#">
              <img src="assets/images/faces-clipart/pic-1.png" alt="profile-img">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="assets/pages/icons/font-awesome.html">
            ...
            <li class="nav-item">
              <a class="nav-link" href="assets/pages/charts/flot-chart.html">
