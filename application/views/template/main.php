  ...
  <div class="container-scroller">
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <h1 class="display-3"> <i class="mdi mdi-gas-station" data-name="mdi-gas-station"></i> FMS</h1>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">{user_greeting}</span>
    ...
    <div class="container-fluid page-body-wrapper">
      <!-- partial:<?php echo base_url('assets/'); ?>partials/_sidebar.html -->
...
<!--           <li class="nav-item nav-profile">
  <div class="nav-link"> -->
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#stations" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-store"></i>
              <span class="menu-title">Stations</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="stations">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('stations/'); ?>">All Stations</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('Stations/new_station'); ?>">New Station</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tanks" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-tag-text-outline"></i>
              <span class="menu-title">Tanks</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="tanks">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('tanks/'); ?>">All Tanks</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('tanks/new_tank'); ?>">New Tank</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="users">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('users/'); ?>">All Users</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('users/new_user'); ?>">New Users</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('secure/logout'); ?>">
